...
func TestGuessImportPath(t *testing.T) {
	...
	testImportPath("./example", "github.com/danielvargas/godocdown/godocdown/example")
	testImportPath("../example", "github.com/danielvargas/godocdown/example")
	if filepath.Separator == '/' {
		// This test does not work well on windows
		testImportPath("/not/in/GOfromSlash", "")
	}
	testImportPath("in/GOfromSlash", "github.com/danielvargas/godocdown/godocdown/in/GOfromSlash")
	testImportPath(".", "github.com/danielvargas/godocdown/godocdown")
	testImportPath("../example/example", "github.com/danielvargas/godocdown/example/example")
}
...
func Test(t *testing.T) {
	...
	if canTestImport() {
		is("# example\n\n    import \"github.com/danielvargas/godocdown/example\"")
	} else {
		is("# example\n")
	}
